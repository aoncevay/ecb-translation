...
def run_llm_translate(model_id = "meta-llama/Meta-Llama-3-8B-Instruct", system_model=True, num_shot=1, num_sample=0, results_dir="results"):
...
if __name__ == "__main__":
    ...
    for model_id, system_model in zip(list_models, list_system_model):
        ...
        for num_shot in list_num_shots:
            ...
            run_llm_translate(model_id=model_id, system_model= system_model, num_shot=num_shot, num_sample=5,results_dir="results.smpl50")
            cleanup()
            print()
